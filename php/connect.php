...
/* configuration */
$user_var = 'COOKIE';
$_COOKIE[$user_var] ? $player_uid = $_COOKIE[$user_var] : $player_uid = $_GET[$user_var];
$key = "OAUTH_KEY";
$secret = "OAUTH_SEC";

/* do not edit after this line */
$api = array_pop(explode('gimmieapi=', $_SERVER['REQUEST_URI']));
$endpoint = "https://api.gimmieworld.com".$api;
